...
{
    public static final Supplier<TrunkPlacerType<PalmTrunkPlacer>> PALM_TRUNK_PLACER = PokecubeWorld.TRUNK_PLACERS
            .register("palm_trunk_placer", () -> new TrunkPlacerType<>(PalmTrunkPlacer.CODEC));
    public static final Supplier<TrunkPlacerType<StraightTrunkPlacerNoDirt>> STRAIGHT_TRUNK_PLACER_NO_DIRT = PokecubeWorld.TRUNK_PLACERS
