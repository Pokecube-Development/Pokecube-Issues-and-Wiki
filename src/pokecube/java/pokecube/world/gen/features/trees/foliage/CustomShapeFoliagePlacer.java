...
public class CustomShapeFoliagePlacer extends FoliagePlacer
{
    ...
    public static final MapCodec<CustomShapeFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec((type) -> {
    ...
    protected void createFoliage(LevelSimulatedReader level, FoliageSetter foliageSetter, RandomSource random,
            TreeConfiguration treeConfig, int maxFreeTreeHeight, FoliagePlacer.FoliageAttachment foliageAttachment,
    ...
    protected void placeLeafSegment(LevelSimulatedReader level, FoliageSetter foliageSetter, RandomSource random,
            TreeConfiguration treeConfig, BlockPos pos, int offset, int range, int yOffset, boolean large)
    {
