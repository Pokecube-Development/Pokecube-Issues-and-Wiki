...
public class ClientProxy
{
    ...
    @SubscribeEvent
    public static void dummy(final FMLLoadCompleteEvent event)
    {
    ...
    public static void initWearables(final RegisterMiscItems event)
    {
        ...
        Client.renderers.put("tiara",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_tiara"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
        ...
        Client.renderers.put("ankletzinnia",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_anklet_zinnia"))
                {
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
                            final EnumWearable slot, final int index, final LivingEntity wearer, final ItemStack stack,
        ...
        Client.renderers.put("pendant",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_pendant"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
        ...
        Client.renderers.put("earring",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_earring"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
        ...
        Client.renderers.put("glasses",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_glasses"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
