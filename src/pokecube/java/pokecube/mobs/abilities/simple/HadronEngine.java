...
@AbilityProvider(name = "hadron-engine")
public class HadronEngine extends Ability
{
    @Override
    public void onAgress(IPokemob mob, LivingEntity target)
    {
        ...
        if (targetMob != null)
        {
            ...
            teffect.setEffectDuration(PokemobTerrainEffects.TerrainEffectType.ELECTRIC,
    ...
    public void preMoveUse(final IPokemob mob, final MoveApplication move)
    {
        ...
        if (teffect.isEffectActive(PokemobTerrainEffects.TerrainEffectType.ELECTRIC) && !attr.hasModifier(PokecubeAttributes.ABILITY_STAT_MOD))
        {
