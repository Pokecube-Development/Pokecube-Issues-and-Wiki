...
public class AI extends Tab
{
    ...
    private static class AIEntry extends Entry<AIEntry>
    {
        ...
        public AIEntry(final AI parent, final IPokemob pokemob, AIButton... buttons)
        {
            ...
            this.top = buttons[0].button().getY();
            this.parent = parent;
        }
                ...
                final float partialTicks)
        {
            ...
            for (var holder : this.buttons)
            {
                ...
                if (y > this.top && y < this.top + parent.list.getHeight())
                {
                    button.setX(x + dx);
                    button.setY(y);
                    button.visible = true;
    ...
    public void init()
    {
        ...
        yOffset += 8;
        xOffset -= 17;
        this.list = new ScrollGui<>(this.parent, this.parent.getMinecraft(), 110, 40, 10, xOffset, yOffset);
