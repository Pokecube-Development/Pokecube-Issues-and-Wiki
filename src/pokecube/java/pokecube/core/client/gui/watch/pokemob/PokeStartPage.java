...
public abstract class PokeStartPage extends WatchPage
{
    ...
    public void init()
    {
        ...
        final TexButton prevBtn = this.addRenderableWidget(new TexButton.Builder(prev, b -> {
            ...
            StartWatch.formChanger.active = (nextEntry != firstEntry && previousEntry != firstEntry) && !this.parent.pokemob.getEntity().isAddedToLevel();
            StartWatch.shiny.active = this.parent.pokemob.getPokedexEntry().hasShiny && !this.parent.pokemob.getEntity().isAddedToLevel();
