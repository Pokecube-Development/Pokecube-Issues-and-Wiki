...
public class GuiDisplayPokecubeInfo extends GuiGraphics
{
    ...
    public static ResourceLocation GUI_LAYER = ResourceLocation.parse("pokecube:gui_layers");
    ...
    {
        event.registerAbove(VanillaGuiLayers.HOTBAR, GUI_LAYER, GuiDisplayPokecubeInfo::renderLayers);
    }

    private static void renderLayers(GuiGraphics guiGraphics, DeltaTracker deltaTracker)
    {
    ...
    public GuiDisplayPokecubeInfo()
    {
        ...
        if (GuiDisplayPokecubeInfo.instance != null) ThutCore.FORGE_BUS.unregister(GuiDisplayPokecubeInfo.instance);
        GuiDisplayPokecubeInfo.instance = this;
        ThutCore.FORGE_BUS.addListener(this::drawSelected);
    }
    ...
    protected void render(GuiGraphics graphics, DeltaTracker deltaTracker)
    {
        ...
        ThutCore.FORGE_BUS.post(new GuiEvent.RenderSelectedInfo(graphics, deltaTracker));
        ThutCore.FORGE_BUS.post(new GuiEvent.RenderTargetInfo(graphics, deltaTracker));
        ThutCore.FORGE_BUS.post(new GuiEvent.RenderTeleports(graphics, deltaTracker));
    }
