...
public class Health
{
            ...
            final int brightness)
    {
        ...
        buffer.addVertex(pos, x1, y1, z).setColor(r, g, b, a).setUv(u0, v1).setLight(brightness);
        buffer.addVertex(pos, x1, y2, z).setColor(r, g, b, a).setUv(u1, v1).setLight(brightness);
        buffer.addVertex(pos, x2, y2, z).setColor(r, g, b, a).setUv(u1, v0).setLight(brightness);
        buffer.addVertex(pos, x2, y1, z).setColor(r, g, b, a).setUv(u0, v0).setLight(brightness);
    }
            ...
            final float partialTicks, final Entity viewPoint, final int br)
    {
        ...
        if (PokecubeCore.getConfig().enableDebugInfo && mc.gui.getDebugOverlay().showDebugScreen() && entity.isMultipartEntity()
                && entity.getParts() != null)
        {
            ...
            for (var p : entity.getParts())
            {
                ...
                guigraphics.drawString(mc.font, g.id, 0, 16, 0xFFFFFFFF, false);
