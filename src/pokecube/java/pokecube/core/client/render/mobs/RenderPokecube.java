...
public class RenderPokecube extends LivingEntityRenderer<EntityPokecube, ModelPokecube>
{
    public static class ModelPokecube extends EntityModel<EntityPokecube>
    {
        ...
        public void renderToBuffer(final PoseStack mat, final VertexConsumer bufferIn, final int packedLightIn,
                final int packedOverlayIn, int colour)
        {
            mat.pushPose();
            ...
            boolean shaking = PokecubeManager.getTilt(item, Minecraft.getInstance().level) > 0;
            ...
            mc.getItemRenderer().render(renderStack, ItemDisplayContext.GROUND, false, mat, this.buffer, packedLightIn,
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "textures/item/pokecubefront.png");
    }
