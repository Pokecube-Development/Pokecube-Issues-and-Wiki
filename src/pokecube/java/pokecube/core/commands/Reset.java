...
public class Reset
{
    ...
    public static int execute(final CommandSourceStack source, final ServerPlayer target) throws CommandSyntaxException
    {
        ...
        source.sendSuccess(() -> Component.translatable("pokecube.command.reset", target.getDisplayName()), true);
        thut.lib.ChatHelper.sendSystemMessage(target, Component.translatable("pokecube.command.canchoose"));
