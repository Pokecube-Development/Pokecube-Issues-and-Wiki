...
{
    public static final Supplier<EntityType<GenericBoat>> BOAT;
    public static final Supplier<EntityType<GenericChestBoat>> CHEST_BOAT;
    public static final Supplier<EntityType<EntityPokemobEgg>> EGG;
    public static final Supplier<EntityType<EntityMoveUse>> MOVE;
    public static final Supplier<EntityType<NpcMob>> NPC;
    public static final Supplier<EntityType<EntityPokecube>> POKECUBE;
    ...
    static
    {
        ...
        CHEST_BOAT = PokecubeCore.ENTITIES.register("chest_boat",
                () -> EntityType.Builder.<GenericChestBoat>of(GenericChestBoat::new, MobCategory.MISC)
                        .sized(1.375F, 0.5625F).clientTrackingRange(10).build("chest_boat"));
        ...
        MOVE = PokecubeCore.ENTITIES.register("move_use",
                () -> EntityType.Builder.of(EntityMoveUse::new, MobCategory.MISC).noSummon().fireImmune()
                        ...
                        .sized(0.5f, 0.5f).build("move_use"));
        NPC = PokecubeCore.ENTITIES.register("npc",
                () -> EntityType.Builder.of(NpcMob::new, MobCategory.CREATURE).build("pokecube:npc"));
