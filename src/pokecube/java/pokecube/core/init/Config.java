...
public class Config extends ConfigData
{
    ...
    {
        final SoundEvent soundevent = BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(id));
    ...
    public boolean spawnInBuilding = true;
    ...
    public void onUpdated()
    {
        ...
        {
            SpawnBiomeMatcher.SOFTBLACKLIST.add(TagKey.create(RegHelper.BIOME_REGISTRY, ResourceLocation.parse(name)));
        }
