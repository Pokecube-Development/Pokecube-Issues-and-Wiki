...
public class ClientSetupHandler
{
    ...
    static
    {
        ...
        mobMove1 = new KeyMapping("key.pokemob.move.1", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        mobMove2 = new KeyMapping("key.pokemob.move.2", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        mobMove3 = new KeyMapping("key.pokemob.move.3", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        mobMove4 = new KeyMapping("key.pokemob.move.4", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        ...
        arrangeGui = new KeyMapping("key.pokemob.arrangegui", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        animateGui = new KeyMapping("key.pokemob.animategui", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
        gzmove = new KeyMapping("key.pokemob.gzmove", KeyConflictContext.IN_GAME, Type.KEYSYM, unk,
                "key.categories.pokecube");
    ...
    {
        event.register(MenuTypes.POKEMOB.get(), GuiPokemob::new);
        event.register(MenuTypes.HEALER.get(), Healer<HealerContainer>::new);
        event.register(MenuTypes.PC.get(), PC<PCContainer>::new);
        event.register(MenuTypes.TRADE.get(), Trade<TradeContainer>::new);
        event.register(MenuTypes.TMS.get(), TMs<TMContainer>::new);
    }
