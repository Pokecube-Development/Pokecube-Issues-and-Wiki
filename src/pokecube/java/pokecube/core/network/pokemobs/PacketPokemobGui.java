...
public class PacketPokemobGui extends Packet
{
    ...
    {
        final Entity entity = PokecubeAPI.getEntityProvider().getEntity(player.level(), this.id, true);
    ...
    private final static Type<Packet> TYPE = new Type<Packet>(ResourceLocation.parse("pokecube:open_pokemob_gui"));
