...
public class PacketTrade extends Packet
{
    ...
    public void handleServer(final ServerPlayer player)
    {
        ...
        if (this.data.contains("s"))
        {
            ...
            if (filled) canInteract = PokecubeManager.getOwner(stack, level).equals(player.getStringUUID());
            ...
            if (slot0 && slot1)
            {
                ...
                if (toTrade)
                {
                    final IPokemob pokemob0 = PokecubeManager.itemToPokemob(pokecube0, player.level());
                    final IPokemob pokemob1 = PokecubeManager.itemToPokemob(pokecube1, player.level());
