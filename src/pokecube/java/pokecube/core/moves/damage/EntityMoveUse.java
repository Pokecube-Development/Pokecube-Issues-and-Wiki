...
public class EntityMoveUse extends ThrowableProjectile
{
    ...
    {
        builder.define(EntityMoveUse.MOVENAME, "");
        builder.define(EntityMoveUse.ENDX, 0f);
        builder.define(EntityMoveUse.ENDY, 0f);
        builder.define(EntityMoveUse.ENDZ, 0f);
        builder.define(EntityMoveUse.STARTX, 0f);
        builder.define(EntityMoveUse.STARTY, 0f);
        builder.define(EntityMoveUse.STARTZ, 0f);
        builder.define(EntityMoveUse.USER, -1);
        builder.define(EntityMoveUse.TARGET, -1);
        builder.define(EntityMoveUse.TICK, 0);
        builder.define(EntityMoveUse.APPLYTICK, 0);
        builder.define(EntityMoveUse.STARTTICK, 0);
    }
