...
public class Curse extends StatusEffect
{
    public Curse(int color)
    {
        super(MobEffectCategory.HARMFUL, color, StatusEffects.CURSE);
    }
    ...
    public boolean applyEffectTick(LivingEntity entity, int amplifier)
    {
        ...
        {
            LivingEntity damageSource = StatusEffects.getSource(StatusEffects.CURSE, entity, level);
            float scale = 1;
            ...
            else entity.hurt(source, scale * entity.getMaxHealth() / 4f);
            return !toRemove;
        }
        return true;
    }
