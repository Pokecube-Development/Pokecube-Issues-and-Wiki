...
public class BerryGenManager
{
    ...
    public static final ResourceLocation REPLACETAG = ResourceLocation.parse("pokecube:berry_tree_replace");
    ...
    public ResourceLocation ROOT = ResourceLocation.fromNamespaceAndPath(PokecubeCore.MODID, "structures/");
    ...
    {
        this.MODID = modid;
        this.ROOT = ResourceLocation.fromNamespaceAndPath(this.MODID, "structures/");
    }
    ...
    public static Supplier<TreeGrower> getTree(ServerLevel worldIn, RandomSource random, int index)
    {
        if (!isTree(index)) return null;
        TreeProvider prov = trees.get(index);
        return prov.getTree(worldIn, random);
    }
