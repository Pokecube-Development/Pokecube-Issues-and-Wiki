...
public class PCInventory extends BigInventory
{
    public static boolean addPokecubeToPC(final ItemStack mob, final Level world)
    {
        ...
        final UUID id = PokecubeManager.getOwnerId(mob, world);
        if (id != null)
        {
    ...
    public static boolean addStackToPC(final UUID uuid, final ItemStack mob, final Level world)
    {
        ...
        final PCInventory pc = PCInventory.getPC(world.registryAccess(), uuid);
    ...
    {
        return PCInventory.getPC(player.registryAccess(), player.getUUID());
    }

    public static PCInventory getPC(Provider access, final UUID uuid)
    {
        return PCManager.INSTANCE.get(access, uuid);
    }
    ...
    public PCInventory(final Manager<? extends BigInventory> manager, HolderLookup.Provider access,
