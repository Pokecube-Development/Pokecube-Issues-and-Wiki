...
{
    public static final ResourceLocation BLOCK_ATLAS = ResourceLocation.parse("pokecube:textures/atlas/slots.png");
    
    public TexturedSlot(final Container inventoryIn, final int index, final int xPosition, final int yPosition,
            final String texture)
    {
        super(inventoryIn, index, xPosition, yPosition);
        this.setBackground(InventoryMenu.BLOCK_ATLAS, ResourceLocation.parse(texture));
    }
