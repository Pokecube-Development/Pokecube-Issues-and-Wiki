    ...
    private void loadFile(final ResourceLocation l, Resource r)
    {
        try
        {
            ...
            for (final Mutations m : loaded)
            {
                ...
                {
                    Map<String, MutationHolder> mutations = this.mutations.get(ResourceLocation.parse(mut.geneType));
                    if (mutations == null)
                        this.mutations.put(ResourceLocation.parse(mut.geneType), mutations = Maps.newHashMap());
