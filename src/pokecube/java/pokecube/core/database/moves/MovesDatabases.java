...
public class MovesDatabases
{
    ...
    public static void preInitLoad()
    {
        ...
        if (PokecubeCore.getConfig().debug_data) PokecubeAPI.logInfo("Moves resources " + resources);
        ...
        if (PokecubeCore.getConfig().debug_data) PokecubeAPI.logInfo("Anims resources " + resources);
        resources.forEach((l, r) -> {
            try
            {
                final InputStreamReader reader = new InputStreamReader(ResourceHelper.getStream(r));
        ...
        if (PokecubeCore.getConfig().debug_data) PokecubeAPI.logInfo("Loaded {} moves and {} animations",
                movesToLoad.size(), animsToLoad.size());
