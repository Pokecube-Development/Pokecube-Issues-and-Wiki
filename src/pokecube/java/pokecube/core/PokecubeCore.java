...
public class PokecubeCore
{
    ...
    public static final PacketHandler packets = new PacketHandler(PokecubeCore.NETVERSION);

    // Holder for our config options
    private static final Config config = new Config();

    // Sided proxy for handling server/client only stuff.
    public static final CommonProxy proxy = DistExecutor.runForDist(() -> pokecube.core.proxy.ClientProxy::new,
    ...
    public PokecubeCore(IEventBus bus, ModContainer modContainer)
    {
        ...
        thut.core.common.config.Config.setupConfigs(modContainer, PokecubeCore.config, PokecubeCore.MODID,
                PokecubeCore.MODID);
        ...
        PokemobCaps.registerAttachment(ATTACHMENTS);
        GuardAICapability.registerAttachment(ATTACHMENTS);
    ...
    private void loadComplete(final FMLLoadCompleteEvent event)
    {
        ...
        event.enqueueWork(() -> {
            ...
            CopyMob.register(EntityTypes.getNpc());
            CopyMob.register(EntityType.ARMOR_STAND);
