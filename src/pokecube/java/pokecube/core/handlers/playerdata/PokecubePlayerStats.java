...
public class PokecubePlayerStats extends PlayerData
{
    ...
    {
        if (this.inspected == null) this.initMaps();
        if (player instanceof ServerPlayer splayer) Triggers.INSPECTPOKEMOB.get().trigger(splayer, pokemob);
    ...
    @Override
    public void writeToNBT(Provider access, final CompoundTag tag_)
    {
