...
public class ClientProxy extends CommonProxy
{
    ...
    public ResourceLocation getPlayerSkin(final String name)
    {
        ...
        SkullBlockEntity.fetchGameProfile(name).thenApply(a -> {
            var profile = a.get();
            final PlayerSkin map = minecraft.getSkinManager().getInsecureSkin(profile);
            ResourceLocation resourcelocation = map.texture();
    ...
    public ResourceLocation getUrlSkin(final String urlSkin)
    {
        ...
        try
        {
            ...
            final ResourceLocation resourcelocation = ResourceLocation.parse("skins/" + s);
            final File file1 = new File(new File(file0, "skins"), s.length() > 2 ? s.substring(0, 2) : "xx");
            file1.mkdirs();
            final File file2 = new File(file1, s);
            final HttpTexture downloadingtexture = new HttpTexture(file2, urlSkin,
                    DefaultPlayerSkin.getDefaultTexture(), true, () ->
                    {});
