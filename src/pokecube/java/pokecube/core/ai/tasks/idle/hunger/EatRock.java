...
public class EatRock extends EatBlockBase
{
    ...
    static
    {
        ...
        toCobble.add(new CobbleConversion(ResourceLocation.fromNamespaceAndPath("minecraft", "budding_amethyst"), Blocks.AMETHYST_BLOCK::defaultBlockState));
        toCobble.add(new CobbleConversion(ResourceLocation.fromNamespaceAndPath("minecraft", "amethyst_block"), Blocks.AIR::defaultBlockState));
