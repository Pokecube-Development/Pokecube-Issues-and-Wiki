...
public abstract class PokemobAI extends PokemobEvolves
{
    ...
    public void postInitAI()
    {
        ...
        if (entity.fireImmune())
        {
            ...
            entity.setPathfindingMalus(PathType.DAMAGE_FIRE, 0);
            entity.setPathfindingMalus(PathType.DANGER_FIRE, 0);
        }
        else
        {
            entity.setPathfindingMalus(PathType.LAVA, -1);
            entity.setPathfindingMalus(PathType.DAMAGE_FIRE, -1);
            entity.setPathfindingMalus(PathType.DANGER_FIRE, 16);
        }
        if (this.swims()) entity.setPathfindingMalus(PathType.WATER, 0);
