...
{
    public static ResourceLocation ANTS = ResourceLocation.fromNamespaceAndPath(PokecubeAPI.MODID, "ants");
    ...
    public static final Supplier<SensorType<NestSensor>> NEST_SENSOR;
    public static final Supplier<SensorType<GatherSensor>> WORK_SENSOR;
    public static final Supplier<SensorType<ThreatSensor>> THREAT_SENSOR;
    public static final Supplier<SensorType<EggSensor>> EGG_SENSOR;
    ...
    public static final ResourceLocation NESTLOC = ResourceLocation.fromNamespaceAndPath(PokecubeCore.MODID, "ant_nest");
