...
public class Edge extends Part
{
    ...
    {
        return this.node1.getCenter().equals(other.node1.getCenter())
                && this.node2.getCenter().equals(other.node2.getCenter());
    }
    ...
    {
        final CompoundTag edgeNbt = super.serializeNBT(provider);
    ...
    public void deserializeNBT(HolderLookup.Provider provider, final CompoundTag nbt)
    {
        ...
        final BlockPos p1 = NbtUtils.readBlockPos(nbt, "n1").get();
        final BlockPos p2 = NbtUtils.readBlockPos(nbt, "n2").get();
        ...
        this.setEnds(NbtUtils.readBlockPos(nbt,"e1").get(), NbtUtils.readBlockPos(nbt,"e2").get());
    }
