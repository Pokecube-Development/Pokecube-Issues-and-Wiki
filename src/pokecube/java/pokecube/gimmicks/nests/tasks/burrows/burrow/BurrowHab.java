...
public class BurrowHab implements IInhabitable, INBTSerializable<CompoundTag>, IWorldTickListener
{
    ...
    public CompoundTag serializeNBT(HolderLookup.Provider provider)
    {
        ...
        nbt.put("burrow", this.burrow.serializeNBT(provider));
        ...
        if (time % 20 == 0)
        {
            ...
            if (this.mobs.isEmpty() && this.eggs.isEmpty())
            {
                final List<EntityType<?>> types = Lists
                        .newArrayList(BuiltInRegistries.ENTITY_TYPE.stream().toList());
    ...
    public void deserializeNBT(HolderLookup.Provider provider, final CompoundTag nbt)
    {
        ...
        this.burrow.deserializeNBT(provider, nbt.getCompound("burrow"));
        this.eggs.clear();
        this.mobs.clear();
        this.mutations.clear();
