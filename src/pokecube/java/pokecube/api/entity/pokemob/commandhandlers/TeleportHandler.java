...
public class TeleportHandler extends DefaultHandler
{
    ...
    {
        return PlayerDataHandler.getInstance().getPlayerData(access(), uuid).getData(PokecubePlayerData.class)
                .getTeleIndex();
    }
    ...
    public static void initTeleportRestrictions()
    {
        ...
        for (final String s : PokecubeCore.getConfig().blackListedTeleDims)
            TeleportHandler.invalidDests.add(ResourceLocation.parse(s));
    }
    ...
    public static void setTeleIndex(final String uuid, int index)
    {
        ...
        PlayerDataHandler.getInstance().getPlayerData(access(), uuid).getData(PokecubePlayerData.class)
                .setTeleIndex(index);
    }
    ...
    public static void setTeleport(final String uuid, final TeleDest teleport)
    {
        ...
        PlayerDataHandler.getInstance().save(access(), uuid, "pokecube-data");
    }
