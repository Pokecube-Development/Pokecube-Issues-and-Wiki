...
public class JsonHelper
{
    ...
    {
        final ResourceLocation key = ResourceLocation.fromNamespaceAndPath(entry.getModId(), entry.getTrimmedName());
    ...
    {
        final ResourceLocation key = ResourceLocation.fromNamespaceAndPath(entry.getModId(), "pokemobs_drops");
