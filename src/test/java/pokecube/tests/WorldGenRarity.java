...
public class WorldGenRarity
{
    ...
    public static void onChat(final ServerChatEvent chat)
    {
        ...
        else if (chat.getMessage().getString().startsWith("Status:Debug_Structures") && LOG != null)
        {
...
//        else if (chat.getMessage().getString().startsWith("Debug:Struct:"))
//        {
//            try
//            {
...
//        }
    ...
    @SubscribeEvent
    public static void onServerTick(final LevelTickEvent.Post event)
    {
        if (LOG != null && event.getLevel() instanceof ServerLevel level)
        {
