...
public class ItemInit
{
    // Keys
    // Orbs
    public static final DeferredItem<Item> BLUE_ORB;
    public static final DeferredItem<Item> GREEN_ORB;
    public static final DeferredItem<Item> RED_ORB;
    public static final DeferredItem<Item> GRAY_ORB;
    public static final DeferredItem<Item> RAINBOW_ORB;
    public static final DeferredItem<Item> LUSTROUS_ORB;
    public static final DeferredItem<Item> ADAMANT_ORB;
    public static final DeferredItem<Item> OCEAN_ORB;
    public static final DeferredItem<Item> LIFE_ORB;
    public static final DeferredItem<Item> DESTRUCT_ORB;
    public static final DeferredItem<Item> REGIS_ORB;
    public static final DeferredItem<Item> KOKO_ORB;
    public static final DeferredItem<Item> BULU_ORB;
    public static final DeferredItem<Item> LELE_ORB;
    public static final DeferredItem<Item> FINI_ORB;
    public static final DeferredItem<Item> SOUL_HEART;
    public static final DeferredItem<Item> SOUL_DEW;

    // Cores
    public static final DeferredItem<Item> ROCK_CORE;
    public static final DeferredItem<Item> ICE_CORE;
    public static final DeferredItem<Item> STEEL_CORE;
    public static final DeferredItem<Item> THUNDER_CORE;
    public static final DeferredItem<Item> DRAGO_CORE;
    public static final DeferredItem<Item> MAGMA_CORE;
    public static final DeferredItem<Item> KYUREM_CORE;
    public static final DeferredItem<Item> STEAM_CORE;

    // Misc
    public static final DeferredItem<Item> LIGHT_STONE;
    public static final DeferredItem<Item> DARK_STONE;
    public static final DeferredItem<Item> EMBLEM;
    public static final DeferredItem<Item> ORANGE_RUNE;
    public static final DeferredItem<Item> BLUE_RUNE;
    public static final DeferredItem<Item> GREEN_RUNE;
    public static final DeferredItem<Item> ICE_CARROT;
    public static final DeferredItem<Item> SHADOW_CARROT;
    public static final DeferredItem<Item> ANCIENT_STONE;
    public static final DeferredItem<Item> IMPRISIONMENT_HELMET;

    public static final DeferredItem<Item> FIRE_WING;
    public static final DeferredItem<Item> DARK_FIRE_WING;
    public static final DeferredItem<Item> ELECTRIC_WING;
    public static final DeferredItem<Item> STATIC_WING;
    public static final DeferredItem<Item> ICE_WING;
    public static final DeferredItem<Item> ICE_DARK_WING;

    public static final DeferredItem<Item> FLAME_GEM;
    public static final DeferredItem<Item> WATER_GEM;
    public static final DeferredItem<Item> THUNDER_GEM;
    public static final DeferredItem<Item> DIAMOND_GEM;
    public static final DeferredItem<Item> AZELF_GEM;
    public static final DeferredItem<Item> MESPRIT_GEM;
    public static final DeferredItem<Item> UXIE_GEM;

    public static final DeferredItem<Item> NIGHTMARE_BOOK;
    public static final DeferredItem<Item> LUNAR_WING;

    public static final DeferredItem<Item> MANAPHY_NECKLACE;

    public static final DeferredItem<Item> MELOETTA_OCARINA;

    public static final DeferredItem<Item> METEOR_SHARD;

    public static final DeferredItem<Item> STAR_CORE;

    public static final DeferredItem<Item> COSMIC_ORB;
    public static final DeferredItem<Item> LIGHTING_CRYSTAL;

    public static final DeferredItem<Item> KUBFU_SCARF;
    public static final DeferredItem<Item> WOODEN_CROWN;
    ...
    // Forms
    public static final DeferredItem<Item> SILVER_WING;
    public static final DeferredItem<Item> RAINBOW_WING;
    public static final DeferredItem<Item> AQUAMARINE_SHARD;
    public static final DeferredItem<Item> GRISEOUS_ORB;
    public static final DeferredItem<Item> ZYGARDE_CUBE;
    public static final DeferredItem<Item> PRISION_BOTTLE;
    public static final DeferredItem<Item> REVEAL_GLASS;
    public static final DeferredItem<Item> DNA_SPLICER_A;
    public static final DeferredItem<Item> DNA_SPLICER_B;
    public static final DeferredItem<Item> METEORITE;
    public static final DeferredItem<Item> N_SOLARIZER;
    public static final DeferredItem<Item> N_LUNARIZER;
    public static final DeferredItem<Item> AZURE_FLUTE;
    public static final DeferredItem<Item> RUSTED_SHIELD;
    public static final DeferredItem<Item> RUSTED_SWORD;
    public static final DeferredItem<Item> REINS_UNITY;

    // Evolutions
    public static final DeferredItem<Item> CHIPPED_POT;
    public static final DeferredItem<Item> CRACKED_POT;
    public static final DeferredItem<Item> GALARCUFF;
    public static final DeferredItem<Item> PARCHMENT_DARK;
    public static final DeferredItem<Item> PARCHMENT_WATER;
    public static final DeferredItem<Item> GALARWREATH;

    // Raids/Dynamax/Gigantamax
    public static final DeferredItem<Item> WISHING_PIECE;
    public static final DeferredItem<Item> GIGANTIC_SHARD;

    // Tools
    public static final DeferredItem<Item> RAINBOW_SWORD;
    public static final DeferredItem<Item> KELDEO_SWORD;
    public static final DeferredItem<Item> VIRIZION_SWORD;
    public static final DeferredItem<Item> COBALION_SWORD;
    public static final DeferredItem<Item> TERRAKION_SWORD;
    public static final DeferredItem<Item> ZAMAZENTA_SHIELD;
    public static final DeferredItem<Item> ZACIAN_SWORD;

    // Dimensions
    public static final DeferredItem<Item> PILE_OF_ASH;
    public static final DeferredItem<Item> SPECTRUM_SHARD;
    public static final DeferredItem<Item> ULTRA_KEY;
    public static final DeferredItem<Item> COSMIC_DUST;
    public static final DeferredItem<Item> FRACTAL_SHARD;
    public static final DeferredItem<Item> DISTORTIC_WATER_BUCKET;

    // Giratina
    public static final DeferredItem<Item> GIRATINA_MIRROR;
    public static final DeferredItem<Item> HEAD_MIRROR;
    public static final DeferredItem<Item> BODY_MIRROR;
    public static final DeferredItem<Item> GLASS_MIRROR;

    // Armor
    public static final DeferredItem<ArmorItem> ULTRA_HELMET;
    public static final DeferredItem<ArmorItem> ULTRA_CHESTPLATE;
    public static final DeferredItem<ArmorItem> ULTRA_LEGGINGS;
    public static final DeferredItem<ArmorItem> ULTRA_BOOTS;

    // Torch
    public static final DeferredItem<Item> INFECTED_TORCH;

    // Plants
    public static final DeferredItem<Item> DISTORTIC_VINES;
    public static final DeferredItem<Item> GOLDEN_SHROOM;
    public static final DeferredItem<Item> GOLDEN_SWEET_BERRIES;
    public static final DeferredItem<Item> PINK_TAINTED_LILY_PAD;
    public static final DeferredItem<Item> TAINTED_LILY_PAD;
    public static final DeferredItem<Item> TEMPORAL_BAMBOO;

    // Foods
    public static final DeferredItem<Item> ASPEAR_POKEPUFF;
    public static final DeferredItem<Item> CHERI_POKEPUFF;
    public static final DeferredItem<Item> CHESTO_POKEPUFF;
    public static final DeferredItem<Item> CORNN_POKEPUFF;
    public static final DeferredItem<Item> ENIGMA_POKEPUFF;
    public static final DeferredItem<Item> GREPA_POKEPUFF;
    public static final DeferredItem<Item> HONDEW_POKEPUFF;
    public static final DeferredItem<Item> JABOCA_POKEPUFF;
    public static final DeferredItem<Item> KELPSY_POKEPUFF;
    public static final DeferredItem<Item> LEPPA_POKEPUFF;
    public static final DeferredItem<Item> LUM_POKEPUFF;
    public static final DeferredItem<Item> NANAB_POKEPUFF;
    public static final DeferredItem<Item> NULL_POKEPUFF;
    public static final DeferredItem<Item> ORAN_POKEPUFF;
    public static final DeferredItem<Item> PECHA_POKEPUFF;
    public static final DeferredItem<Item> PERSIM_POKEPUFF;
    public static final DeferredItem<Item> PINAP_POKEPUFF;
    public static final DeferredItem<Item> POMEG_POKEPUFF;
    public static final DeferredItem<Item> QUALOT_POKEPUFF;
    public static final DeferredItem<Item> RAWST_POKEPUFF;
    public static final DeferredItem<Item> ROWAP_POKEPUFF;
    public static final DeferredItem<Item> SITRUS_POKEPUFF;
    public static final DeferredItem<Item> TAMATO_POKEPUFF;

    // Signs
    public static final DeferredItem<Item> AGED_SIGN;
    public static final DeferredItem<Item> CONCRETE_SIGN;
    public static final DeferredItem<Item> CONCRETE_DENSE_SIGN;
    public static final DeferredItem<Item> CORRUPTED_SIGN;
    public static final DeferredItem<Item> DISTORTIC_SIGN;
    public static final DeferredItem<Item> INVERTED_SIGN;
    public static final DeferredItem<Item> MIRAGE_SIGN;
    public static final DeferredItem<Item> TEMPORAL_SIGN;

    // Hanging Signs
    public static final DeferredItem<Item> AGED_HANGING_SIGN;
    public static final DeferredItem<Item> CONCRETE_HANGING_SIGN;
    public static final DeferredItem<Item> CORRUPTED_HANGING_SIGN;
    public static final DeferredItem<Item> DISTORTIC_HANGING_SIGN;
    public static final DeferredItem<Item> INVERTED_HANGING_SIGN;
    public static final DeferredItem<Item> MIRAGE_HANGING_SIGN;
    public static final DeferredItem<Item> TEMPORAL_HANGING_SIGN;

    public static Map<Nature, DeferredItem<Item>> mints = Maps.newHashMap();
    public static Map<PokeType, DeferredItem<Item>> zCrystals = Maps.newHashMap();
