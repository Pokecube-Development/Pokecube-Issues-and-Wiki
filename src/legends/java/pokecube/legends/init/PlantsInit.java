...
{
    public static final DeferredBlock<Block> AGED_SAPLING;
    public static final DeferredBlock<Block> AZURE_COLEUS;
    public static final DeferredBlock<Block> COMPRECED_MUSHROOM;
    public static final DeferredBlock<Block> CORRUPTED_GRASS;
    public static final DeferredBlock<Block> CORRUPTED_SAPLING;
    public static final DeferredBlock<Block> CRYSTALLIZED_BUSH;
    public static final DeferredBlock<Block> CRYSTALLIZED_CACTUS;
    public static final DeferredBlock<Block> DISTORCED_MUSHROOM;
    public static final DeferredBlock<Block> DISTORTIC_GRASS;
    public static final DeferredBlock<Block> DISTORTIC_SAPLING;
    public static final DeferredBlock<Block> DISTORTIC_VINES;
    public static final DeferredBlock<Block> DISTORTIC_VINES_PLANT;
    public static final DeferredBlock<Block> GOLDEN_ALLIUM;
    public static final DeferredBlock<Block> GOLDEN_AZURE_BLUET;
    public static final DeferredBlock<Block> GOLDEN_CORNFLOWER;
    public static final DeferredBlock<Block> GOLDEN_DANDELION;
    public static final DeferredBlock<Block> GOLDEN_FERN;
    public static final DeferredBlock<Block> GOLDEN_GRASS;
    public static final DeferredBlock<Block> GOLDEN_LILY_VALLEY;
    public static final DeferredBlock<Block> GOLDEN_ORCHID;
    public static final DeferredBlock<Block> GOLDEN_OXEYE_DAISY;
    public static final DeferredBlock<Block> BIG_CONTAMINATED_DRIPLEAF;
    public static final DeferredBlock<Block> BIG_CONTAMINATED_DRIPLEAF_STEM;
    public static final DeferredBlock<Block> POLLUTING_BLOSSOM;
    public static final DeferredBlock<Block> SMALL_CONTAMINATED_DRIPLEAF;
    public static final DeferredBlock<Block> DYNA_SHRUB;
    public static final DeferredBlock<Block> GOLDEN_POPPY;
    public static final DeferredBlock<Block> GOLDEN_SHROOM_PLANT;
    public static final DeferredBlock<Block> GOLDEN_SWEET_BERRY_BUSH;
    public static final DeferredBlock<Block> GOLDEN_TULIP;
    public static final DeferredBlock<Block> GRACIDEA;
    public static final DeferredBlock<Block> HANGING_TENDRILS;
    public static final DeferredBlock<Block> HANGING_TENDRILS_PLANT;
    public static final DeferredBlock<Block> INVERTED_ORCHID;
    public static final DeferredBlock<Block> INVERTED_SAPLING;
    public static final DeferredBlock<Block> LARGE_GOLDEN_FERN;
    public static final DeferredBlock<Block> MIRAGE_SAPLING;
    public static final DeferredBlock<Block> PINK_TAINTED_LILY_PAD;
    public static final DeferredBlock<Block> PURPLE_WISTERIA_VINES;
    public static final DeferredBlock<Block> PURPLE_WISTERIA_VINES_PLANT;
    public static final DeferredBlock<Block> STRING_OF_PEARLS;
    public static final DeferredBlock<Block> TAINTED_KELP;
    public static final DeferredBlock<Block> TAINTED_KELP_PLANT;
    public static final DeferredBlock<Block> TAINTED_LILY_PAD;
    public static final DeferredBlock<Block> TAINTED_ROOTS;
    public static final DeferredBlock<Block> TAINTED_SEAGRASS;
    public static final DeferredBlock<Block> TALL_CORRUPTED_GRASS;
    public static final DeferredBlock<Block> TALL_CRYSTALLIZED_BUSH;
    public static final DeferredBlock<Block> TALL_GOLDEN_GRASS;
    public static final DeferredBlock<Block> TALL_TAINTED_SEAGRASS;
    public static final DeferredBlock<Block> TEMPORAL_BAMBOO;
    public static final DeferredBlock<Block> TEMPORAL_BAMBOO_SHOOT;
    public static final DeferredBlock<Block> TEMPORAL_SAPLING;
