...
{
   public static final TagKey<Block> FEATURES_CANNOT_PLACE_ON = TagKey.create(RegHelper.BLOCK_REGISTRY,ResourceLocation.parse(Reference.ID, "features_cannot_place_on"));
