...
public class LegendsRegistryChangeFixer
{
    private static final Set<ResourceLocation> distortic_framed_mirror =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:framed_distortic_mirror"));
    private static final Set<ResourceLocation> one_way_framed_mirror =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_framed_mirror"));
    private static final Set<ResourceLocation> one_way_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_glass"));
    private static final Set<ResourceLocation> one_way_tinted_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_tinted_glass"));
    private static final Set<ResourceLocation> one_way_white_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_white_stained_glass"));
    private static final Set<ResourceLocation> one_way_light_gray_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_light_gray_stained_glass"));
    private static final Set<ResourceLocation> one_way_gray_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_gray_stained_glass"));
    private static final Set<ResourceLocation> one_way_black_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_black_stained_glass"));
    private static final Set<ResourceLocation> one_way_brown_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_brown_stained_glass"));
    private static final Set<ResourceLocation> one_way_red_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_red_stained_glass"));
    private static final Set<ResourceLocation> one_way_orange_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_orange_stained_glass"));
    private static final Set<ResourceLocation> one_way_yellow_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_yellow_stained_glass"));
    private static final Set<ResourceLocation> one_way_lime_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_lime_stained_glass"));
    private static final Set<ResourceLocation> one_way_green_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_green_stained_glass"));
    private static final Set<ResourceLocation> one_way_cyan_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_cyan_stained_glass"));
    private static final Set<ResourceLocation> one_way_light_blue_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_light_blue_stained_glass"));
    private static final Set<ResourceLocation> one_way_blue_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_blue_stained_glass"));
    private static final Set<ResourceLocation> one_way_purple_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_purple_stained_glass"));
    private static final Set<ResourceLocation> one_way_magenta_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_magenta_stained_glass"));
    private static final Set<ResourceLocation> one_way_pink_stained_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_pink_stained_glass"));
    private static final Set<ResourceLocation> one_way_spectrum_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_spectrum_glass"));
    private static final Set<ResourceLocation> one_way_mirage_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_mirage_glass"));
    private static final Set<ResourceLocation> one_way_laboratory_glass =
            Sets.newHashSet(ResourceLocation.parse("pokecube_legends:distortic_one_way_laboratory_glass"));
