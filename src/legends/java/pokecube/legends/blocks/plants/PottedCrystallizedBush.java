...
public class PottedCrystallizedBush extends FlowerPotBlock
{
    ...
    @Nullable
    @Override
    public PathType getBlockPathType(final BlockState state, final BlockGetter world, final BlockPos pos, @Nullable final Mob entity)
    {
