...
public class MovesUtils implements IMoveConstants
{
    ...
    public static ExplosionCustom newExplosion(final Entity entity, final double x, final double y,
            final double z, final float power)
    {
        final ExplosionCustom var11 = new ExplosionCustom(entity.getEntityWorld(), entity, x, y, z, power)
