...
public class FeaturesInit
{
    ...
    private static final RegistryObject<ConfiguredFeature<?, ?>> ORE_FOSSIL_SMALL_FEATURE = PokecubeCore.RegistryEvents.CONFIGURED_FEATURES
            .register("fossil_ore",
                    () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(getOres(), 4, 0.5f)));
    private static final RegistryObject<ConfiguredFeature<?, ?>> ORE_FOSSIL_LARGE_FEATURE = PokecubeCore.RegistryEvents.CONFIGURED_FEATURES
            .register("fossil_ore_large",
                    () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(getOres(), 12, 0.7f)));
    private static final RegistryObject<ConfiguredFeature<?, ?>> ORE_FOSSIL_BURIED_FEATURE = PokecubeCore.RegistryEvents.CONFIGURED_FEATURES
            .register("fossil_ore_buried",
                    () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(getOres(), 8, 1.0f)));

    public static final RegistryObject<PlacedFeature> PLACED_SMALL_FOSSIL = PokecubeCore.RegistryEvents.PLACED_FEATURES
            .register("fossil_ore",
                    () -> new PlacedFeature(ORE_FOSSIL_SMALL_FEATURE.getHolder().get(),
                            List.of(CountPlacement.of(5), InSquarePlacement.spread(), HeightRangePlacement
                                    ...
                                    BiomeFilter.biome())));
    public static final RegistryObject<PlacedFeature> PLACED_LARGE_FOSSIL = PokecubeCore.RegistryEvents.PLACED_FEATURES
            .register("fossil_ore_large",
                    () -> new PlacedFeature(ORE_FOSSIL_LARGE_FEATURE.getHolder().get(),
                            List.of(CountPlacement.of(8), InSquarePlacement.spread(), HeightRangePlacement
                                    .triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(380)),
                                    BiomeFilter.biome())));
    public static final RegistryObject<PlacedFeature> PLACED_BURIED_FOSSIL = PokecubeCore.RegistryEvents.PLACED_FEATURES
            .register("fossil_ore_buried",
