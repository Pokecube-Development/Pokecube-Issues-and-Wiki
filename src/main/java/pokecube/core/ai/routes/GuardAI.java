...
public class GuardAI extends Goal
{
    ...
    {
        if (this.capability.hasActiveTask(this.entity.level().getDayTime(), 24000)) this.capability
    ...
    public boolean canContinueToUse()
    {
        ...
        if (!this.capability.hasActiveTask(this.entity.level().getDayTime(), 24000)) return false;
