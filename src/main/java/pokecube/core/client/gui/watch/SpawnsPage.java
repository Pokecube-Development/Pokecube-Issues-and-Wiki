...
public class SpawnsPage extends ListPage<LineEntry>
{
    ...
    public void initList()
    {
        ...
        for (final PokedexEntry pokeEntry : names)
        {
            ...
            int num = 4;
            final ITextComponent water0 = new StringTextComponent(I18n.format("pokewatch.spawns.water_only"));
            final ITextComponent water1 = new StringTextComponent(I18n.format("pokewatch.spawns.water_optional"));
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks)
    {
        ...
        if (this.last != PacketPokedex.selectedLoc.size())
        {
            this.initList();
