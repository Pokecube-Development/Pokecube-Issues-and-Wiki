...
public class PokemobInfoPage extends PageWithSubPages<PokeInfoPage>
{
    ...
    public void preSubOpened()
    {
        ...
        //Stats
        final TexButton infoStats = this.addRenderableWidget(new TexButton(x + 12, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(0);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(127, 72, 17, 17)));
        //Battle
        final TexButton infoBattle = this.addRenderableWidget(new TexButton(x + 28, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(1);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(144, 72, 17, 17)));
        //
        final TexButton infoMoves = this.addRenderableWidget(new TexButton(x + 44, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(2);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(161, 72, 17, 17)));
        //Spawns
        final TexButton infoSpawn = this.addRenderableWidget(new TexButton(x + 60, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(3);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(178, 72, 17, 17)));
        //Mates
        final TexButton infoMates = this.addRenderableWidget(new TexButton(x + 76, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(4);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(195, 72, 17, 17)));
        //Description
        final TexButton infoDescr = this.addRenderableWidget(new TexButton(x + 92, y - 82, 17, 17, TComponent.literal(""), b -> {
            this.changePage(5);
            PokemobInfoPage.savedIndex = this.index;
        }).setTex(GuiPokeWatch.getWidgetTex()).setRender(new UVImgRender(212, 72, 17, 17)));

        //Shiny Button
        final TexButton shinyButton = this.addRenderableWidget(new TexButton(x - 50, y + 45, 12, 12, TComponent.literal(""), b -> {
