...
public class PC<T extends PCContainer> extends ContainerScreen<T>
{
    ...
    public void render(final int mouseX, final int mouseY, final float f)
    {
        ...
        // FIXME PC Search feature.
        // for (int i = 0; i < 54; i++)
        // if (!this.textFieldSearch.getText().isEmpty())
        // {
        // final ItemStack stack = this.container.inv.getStackInSlot(i + 54 *
        // this.container.inv.getPage());
        ...
        // final String name = stack == null ? "" :
        // stack.getDisplayName().getFormattedText();
        // if (name.isEmpty() ||
        // !name.toLowerCase(java.util.Locale.ENGLISH).contains(this.textFieldSearch
