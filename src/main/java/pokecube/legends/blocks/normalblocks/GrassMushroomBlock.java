...
public class GrassMushroomBlock extends GrassBlock implements IGrowable
{
    public GrassMushroomBlock(final String name, final Properties properties)
    {
        super(properties);
    ...
    public static void executeProcedure(final java.util.HashMap<String, Object> dependencies)
    {
        ...
        if (entity instanceof ServerPlayerEntity) {
        	if ((((PlayerEntity) entity).inventory.armor.get(3).getItem() != new ItemStack(ItemInit.ULTRA_HELMET.get(), 1).getItem()) ||
                ...
                {
    			((LivingEntity) entity).addEffect(new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 60, 1));
                }
        }
    }
}
