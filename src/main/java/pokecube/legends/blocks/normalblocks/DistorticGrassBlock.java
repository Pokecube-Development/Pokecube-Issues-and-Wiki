...
public class DistorticGrassBlock extends DirectionalBlock
{
    public DistorticGrassBlock(final AbstractBlock.Properties properties)
    {
        super(properties);
    ...
    public void stepOn(final World world, final BlockPos pos, final Entity entity)
    {
        super.stepOn(world, pos, entity);
        {
            ...
            DistorticGrassBlock.executeProcedure($_dependencies);
        }
    }
