...
public class ConcretePlankBarrel extends ContainerBlock 
{
	public static final DirectionProperty FACING = BlockStateProperties.FACING;
	public static final BooleanProperty OPEN = BlockStateProperties.OPEN;
	
	public ConcretePlankBarrel(Properties props) {
		super(props);
	...
	public void setPlacedBy(World world, BlockPos pos, BlockState state,
		...
		if (stack.hasCustomHoverName()) {
			...
			if (tileentity instanceof ConcreteBarrelTile) {
				((ConcreteBarrelTile) tileentity).setCustomName(stack.getHoverName());
			}
		}
	}
	...
	public ActionResultType use(BlockState state, World world, BlockPos pos,
		...
		if (world.isClientSide) {
			...
			TileEntity tileentity = world.getBlockEntity(pos);
			if (tileentity instanceof ConcreteBarrelTile) {
				player.openMenu((ConcreteBarrelTile) tileentity);
	...
	public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
		...
		if (tileentity instanceof ConcreteBarrelTile) {
			((ConcreteBarrelTile) tileentity).recheckOpen();
		}
	}
