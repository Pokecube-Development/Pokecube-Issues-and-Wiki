...
public class DistorticRecipeSerializer implements IRecipe<IInventory> {
    ...
    public DistorticRecipeSerializer(ResourceLocation id, Ingredient input, ItemStack output, Block block, ResourceLocation dimId) {
    ...
    public IRecipeSerializer<?> getSerializer () {      
        return DistorticRecipeManager.DISTORTIC.get();
    }
    
    @Override
    public IRecipeType<?> getType () {
        
        return DistorticRecipeManager.DISTORTIC_TYPE;
    }
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements
    	IRecipeSerializer<DistorticRecipeSerializer> 
    {
    	
    	@Override
		public DistorticRecipeSerializer fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new DistorticRecipeSerializer(recipeId, input, output, block, dimID);
        }
        
        @Override
		public DistorticRecipeSerializer fromNetwork(ResourceLocation recipeId, PacketBuffer buffer) 
        {      
        ...
        @Override
        public void toNetwork(PacketBuffer buffer, DistorticRecipeSerializer recipe) 
        {
