...
public class LegendsBoatItem extends Item
{
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final LegendsBoat.Type type;

    public LegendsBoatItem(LegendsBoat.Type type, Properties properties)
    {
        super(properties);
        this.type = type;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand)
    {
        ...
        } else
        {
            ...
            {
                LegendsBoat boat = new LegendsBoat(world, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
