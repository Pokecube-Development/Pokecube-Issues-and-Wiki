...
public class Rayquaza extends Condition
{
    ...
    public boolean canCapture(Entity trainer, IPokemob pokemon)
    {
        ...
        boolean kyogre = CaptureStats.getTotalNumberOfPokemobCaughtBy(trainer.getUniqueID(),
                Database.getEntry("kyogre")) > 0;
        boolean groudon = CaptureStats.getTotalNumberOfPokemobCaughtBy(trainer.getUniqueID(),
                Database.getEntry("groudon")) > 0;
                
        String name = "Kyogre, Groudon";
