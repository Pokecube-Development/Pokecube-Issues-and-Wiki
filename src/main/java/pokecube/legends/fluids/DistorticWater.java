...
{
    public static final ResourceLocation DISTORTIC_WATER_STILL_TEXTURE = new ResourceLocation("pokecube_legends:block/distortic_water_still");
    public static final ResourceLocation DISTORTIC_WATER_FLOWING_TEXTURE = new ResourceLocation("pokecube_legends:block/distortic_water_flow");
    public static final ResourceLocation DISTORTIC_WATER_OVERLAY_TEXTURE = new ResourceLocation("pokecube_legends:block/distortic_water_overlay");
