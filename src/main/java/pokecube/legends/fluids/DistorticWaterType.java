...
{
    public static final ResourceLocation UNDERWATER_LOCATION = new ResourceLocation(
            "pokecube_legends:textures/misc/distortic_underwater.png");
    public static final ResourceLocation DISTORTIC_WATER_STILL = new ResourceLocation(
            "pokecube_legends:block/distortic_water_still");
    public static final ResourceLocation DISTORTIC_WATER_FLOWING = new ResourceLocation(
            "pokecube_legends:block/distortic_water_flowing");
    public static final ResourceLocation DISTORTIC_WATER_OVERLAY = new ResourceLocation(
