...
public class DistortedModDimension extends ModDimension
{

    @Override
    public BiFunction<World, DimensionType, ? extends Dimension> getFactory()
    {
        return DistortionWorldConfig.DistortedDimension::new;
    }

    public static void sentToDistorted(final ServerPlayerEntity player)
    {
        final DimensionType targetDim = ModDimensions.DIMENSION_TYPE_DW;
