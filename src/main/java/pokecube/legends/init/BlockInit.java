...
//                Material.GOURD, 2.5F, SoundType.METAL, ToolType.PICKAXE, 2).noInfoBlock());
        ...
        INVERTED_WOOD 		= PokecubeLegends.BLOCKS_TAB.register("inverted_wood", () -> Blocks.createLogBlock(MaterialColor.PURPLE, Block.Properties.from(Blocks.OAK_WOOD).lightValue(6)));
        STRIP_INVERTED_LOG 	= PokecubeLegends.BLOCKS_TAB.register("stripped_inverted_log", () -> Blocks.createLogBlock(MaterialColor.BLUE, Block.Properties.from(Blocks.OAK_WOOD)));
        STRIP_INVERTED_WOOD = PokecubeLegends.BLOCKS_TAB.register("stripped_inverted_wood", () -> Blocks.createLogBlock(MaterialColor.BLUE, Block.Properties.from(Blocks.OAK_WOOD)));
        ...
        TEMPORAL_WOOD 		= PokecubeLegends.BLOCKS_TAB.register("temporal_wood", () -> Blocks.createLogBlock(MaterialColor.GREEN, Block.Properties.from(Blocks.OAK_WOOD).lightValue(6)));
        STRIP_TEMPORAL_LOG 	= PokecubeLegends.BLOCKS_TAB.register("stripped_temporal_log", () -> Blocks.createLogBlock(MaterialColor.LIME, Block.Properties.from(Blocks.OAK_WOOD)));
        STRIP_TEMPORAL_WOOD = PokecubeLegends.BLOCKS_TAB.register("stripped_temporal_wood", () -> Blocks.createLogBlock(MaterialColor.LIME, Block.Properties.from(Blocks.OAK_WOOD)));
        ...
        AGED_WOOD 			= PokecubeLegends.BLOCKS_TAB.register("aged_wood", () -> Blocks.createLogBlock(MaterialColor.GOLD, Block.Properties.from(Blocks.OAK_WOOD).lightValue(6)));
        STRIP_AGED_LOG 		= PokecubeLegends.BLOCKS_TAB.register("stripped_aged_log", () -> Blocks.createLogBlock(MaterialColor.BROWN, Block.Properties.from(Blocks.OAK_WOOD)));
        STRIP_AGED_WOOD 	= PokecubeLegends.BLOCKS_TAB.register("stripped_aged_wood", () -> Blocks.createLogBlock(MaterialColor.BROWN, Block.Properties.from(Blocks.OAK_WOOD)));
        ULTRA_PLANKUB03 	= PokecubeLegends.BLOCKS_TAB.register("ultra_plank03", () -> new Block(Block.Properties.from(Blocks.OAK_PLANKS)));
        AGED_STAIRS 		= PokecubeLegends.BLOCKS_TAB.register("aged_stairs", () -> new ItemGenerator.GenericWoodStairs(Blocks.OAK_PLANKS.getDefaultState(), Block.Properties.from(Blocks.OAK_PLANKS).sound(SoundType.WOOD).hardnessAndResistance(2.0f, 3.0f)));
