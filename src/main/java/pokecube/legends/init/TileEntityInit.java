...
public class TileEntityInit 
{
    ...
    static
    {
    	GENERIC_BARREL_TILE = PokecubeLegends.TILES.register("generic_barrel", () -> TileEntityType.Builder.of(
			...
			BlockInit.CONCRETE_DENSE_BARREL.get(), BlockInit.INVERTED_BARREL.get(), BlockInit.TEMPORAL_BARREL.get(),
			BlockInit.MIRAGE_BARREL.get(), BlockInit.CORRUPTED_BARREL.get(), BlockInit.DISTORTIC_BARREL.get(),
			BlockInit.DISTORTIC_STONE_BARREL.get()).build(null));
