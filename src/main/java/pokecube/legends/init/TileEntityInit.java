...
{
	// Tile
    public static final RegistryObject<BlockEntityType<GenericBarrelTile>> GENERIC_BARREL_TILE;
    public static final RegistryObject<BlockEntityType<GenericBookshelfEmptyTile>> GENERIC_BOOKSHELF_EMPTY_TILE;

    static
    {
    	GENERIC_BARREL_TILE = PokecubeLegends.TILES.register("generic_barrel", () -> BlockEntityType.Builder.of(
		...
		GENERIC_BOOKSHELF_EMPTY_TILE = PokecubeLegends.TILES.register("generic_bookshelf_empty", () -> BlockEntityType.Builder.of(
