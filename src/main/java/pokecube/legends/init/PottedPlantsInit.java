...
public class PottedPlantsInit
{
    ...
    {
        // No Tab
        POTTED_AGED_SAPLING = PokecubeLegends.BLOCKS.register("potted_aged_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.AGED_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_AZURE_COLEUS = PokecubeLegends.BLOCKS.register("potted_azure_coleus",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.AZURE_COLEUS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_CORRUPTED_SAPLING = PokecubeLegends.BLOCKS.register("potted_corrupted_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.CORRUPTED_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_CORRUPTED_GRASS = PokecubeLegends.BLOCKS.register("potted_corrupted_grass",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.CORRUPTED_GRASS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_DISTORTIC_SAPLING = PokecubeLegends.BLOCKS.register("potted_distortic_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.DISTORTIC_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_INVERTED_SAPLING = PokecubeLegends.BLOCKS.register("potted_inverted_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.INVERTED_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_MIRAGE_SAPLING = PokecubeLegends.BLOCKS.register("potted_mirage_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.MIRAGE_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TEMPORAL_SAPLING = PokecubeLegends.BLOCKS.register("potted_temporal_sapling",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.TEMPORAL_SAPLING.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));

        POTTED_COMPRECED_MUSHROOM = PokecubeLegends.BLOCKS.register("potted_compreced_mushroom",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.COMPRECED_MUSHROOM.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_CRYSTALLIZED_BUSH = PokecubeLegends.BLOCKS.register("potted_crystallized_bush",
                () -> new PottedCrystallizedBush(BlockInit.CRYSTALLIZED_BUSH.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_CRYSTALLIZED_CACTUS = PokecubeLegends.BLOCKS.register("potted_crystallized_cactus",
                () -> new PottedCrystallizedCactus(BlockInit.CRYSTALLIZED_CACTUS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_DISTORCED_MUSHROOM = PokecubeLegends.BLOCKS.register("potted_distorced_mushroom",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.DISTORCED_MUSHROOM.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_DISTORTIC_GRASS = PokecubeLegends.BLOCKS.register("potted_distortic_grass",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.DISTORTIC_GRASS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_DISTORTIC_VINES = PokecubeLegends.BLOCKS.register("potted_distortic_vines",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.DISTORTIC_VINES.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_DYNA_SHRUB = PokecubeLegends.BLOCKS.register("potted_dyna_shrub",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.DYNA_SHRUB.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_ALLIUM = PokecubeLegends.BLOCKS.register("potted_golden_allium",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_ALLIUM.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_AZURE_BLUET = PokecubeLegends.BLOCKS.register("potted_golden_azure_bluet",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_AZURE_BLUET.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_CORNFLOWER = PokecubeLegends.BLOCKS.register("potted_golden_cornflower",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_CORNFLOWER.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_DANDELION = PokecubeLegends.BLOCKS.register("potted_golden_dandelion",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_DANDELION.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_LILY_VALLEY = PokecubeLegends.BLOCKS.register("potted_golden_lily_of_the_valley",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_LILY_VALLEY.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_FERN = PokecubeLegends.BLOCKS.register("potted_golden_fern",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_FERN.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_GRASS = PokecubeLegends.BLOCKS.register("potted_golden_grass",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_GRASS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_ORCHID = PokecubeLegends.BLOCKS.register("potted_golden_orchid",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_ORCHID.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_OXEYE_DAISY = PokecubeLegends.BLOCKS.register("potted_golden_oxeye_daisy",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_OXEYE_DAISY.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_POPPY = PokecubeLegends.BLOCKS.register("potted_golden_poppy",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_POPPY.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_SHROOM = PokecubeLegends.BLOCKS.register("potted_golden_shroom",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_SHROOM_PLANT.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_SWEET_BERRY_BUSH = PokecubeLegends.BLOCKS.register("potted_golden_sweet_berry_bush",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_SWEET_BERRY_BUSH.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_GOLDEN_TULIP = PokecubeLegends.BLOCKS.register("potted_golden_tulip",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.GOLDEN_TULIP.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_INVERTED_ORCHID = PokecubeLegends.BLOCKS.register("potted_inverted_orchid",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.INVERTED_ORCHID.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_HANGING_TENDRILS = PokecubeLegends.BLOCKS.register("potted_hanging_tendrils",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.HANGING_TENDRILS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_LARGE_GOLDEN_FERN = PokecubeLegends.BLOCKS.register("potted_large_golden_fern",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.LARGE_GOLDEN_FERN.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_PINK_LILY = PokecubeLegends.BLOCKS.register("potted_pink_blossom_lily",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.PINK_TAINTED_LILY_PAD.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_POLLUTING_BLOSSOM = PokecubeLegends.BLOCKS.register("potted_polluting_blossom",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.POLLUTING_BLOSSOM.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_PURPLE_WISTERIA_VINES = PokecubeLegends.BLOCKS.register("potted_purple_wisteria_vines",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.PURPLE_WISTERIA_VINES.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_STRING_OF_PEARLS = PokecubeLegends.BLOCKS.register("potted_string_of_pearls",
                () -> new ItemGenerator.GenericPottedPlant(BlockInit.STRING_OF_PEARLS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TAINTED_ROOTS = PokecubeLegends.BLOCKS.register("potted_tainted_roots",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.TAINTED_ROOTS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TALL_CRYSTALLIZED_BUSH = PokecubeLegends.BLOCKS.register("potted_tall_crystallized_bush",
                () -> new PottedCrystallizedBush(BlockInit.TALL_CRYSTALLIZED_BUSH.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TALL_CORRUPTED_GRASS = PokecubeLegends.BLOCKS.register("potted_tall_corrupted_grass",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.TALL_CORRUPTED_GRASS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TALL_GOLDEN_GRASS = PokecubeLegends.BLOCKS.register("potted_tall_golden_grass",
                () -> new ItemGenerator.GenericPottedPlant(PlantsInit.TALL_GOLDEN_GRASS.get(),
                        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)));
        POTTED_TEMPORAL_BAMBOO = PokecubeLegends.BLOCKS.register("potted_temporal_bamboo",
