...
public class LegendsBoatDispenseHandler extends DefaultDispenseItemBehavior
{
    private final DefaultDispenseItemBehavior defaultDispenseItemBehavior = new DefaultDispenseItemBehavior();
    private final LegendsBoat.Type type;

    public LegendsBoatDispenseHandler(LegendsBoat.Type type)
    {
        this.type = type;
    }
    ...
    public ItemStack execute(BlockSource source, ItemStack stack)
    {
        ...
        LegendsBoat boat = new LegendsBoat(level, d0, d1 + d3, d2);
