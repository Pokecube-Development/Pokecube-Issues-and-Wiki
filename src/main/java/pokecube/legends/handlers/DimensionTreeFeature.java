...
public class DimensionTreeFeature extends Feature<BaseTreeFeatureConfig> {

    public DimensionTreeFeature(Codec<BaseTreeFeatureConfig> codec) {
        super(codec);
    }
    ...
    private static boolean isDeepturf(IWorldGenerationBaseReader world, BlockPos pos) {
        return world.hasBlockState(pos, (state) -> {
            ...
            return block == BlockInit.ULTRA_MAGNETIC.get();
        });
    }
