...
public class Splicer extends AbstractContainerScreen<SplicerContainer>
{
    ...
    protected void renderBg(final GuiGraphics graphics, final float partialTicks, final int mouseX, final int mouseY)
    {
        ...
        graphics.blit(new ResourceLocation(PokecubeAdv.MODID, "textures/gui/splicer.png"), x + 78, y + 34, 176, 0, l1 + 1, 16);
    }
    ...
    protected void renderLabels(final GuiGraphics graphics, final int mouseX, final int mouseY)
    {
        ...
        graphics.drawString(this.font, warning0.getString(), dx, dy, 0xbf1e0b);
        graphics.pose().pushPose();
        final float s = 0.5f;
        graphics.pose().scale(s, s, s);
        graphics.drawString(this.font, warning1.getString(), (int) ((dx - 20) / s), (int) ((dy + 10) / s), 0xbf1e0b);
