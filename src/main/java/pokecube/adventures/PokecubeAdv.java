...
public class PokecubeAdv
{
    ...
    static
    {
        AFA = new AfaBlock(Block.Properties.create(Material.IRON));
        COMMANDER = new CommanderBlock(Block.Properties.create(Material.IRON));
        DAYCARE = new DaycareBlock(Block.Properties.create(Material.IRON));
        CLONER = new ClonerBlock(Block.Properties.create(Material.IRON));
        EXTRACTOR = new ExtractorBlock(Block.Properties.create(Material.IRON));
        SPLICER = new SplicerBlock(Block.Properties.create(Material.IRON));
        SIPHON = new SiphonBlock(Block.Properties.create(Material.IRON));
