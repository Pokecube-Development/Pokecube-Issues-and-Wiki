...
public interface ICanEvolve extends IHasEntry, IHasOwner
{
    ...
    default IPokemob evolve(final boolean delayed, final boolean init, final ItemStack stack)
    {
        ...
        // TODO: Check this
        SpawnCheck check = new SpawnCheck(new Vector3(thisEntity), (ServerLevelAccessor) thisEntity.level, thisEntity.blockPosition, thisEntity.level().getBlockState(thisEntity.blockPosition));
