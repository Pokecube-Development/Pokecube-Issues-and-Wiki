...
public class GuiNBTButton extends Button
{
    ...
    {
        super(x, y, GuiNBTButton.WIDTH, GuiNBTButton.HEIGHT, "", onPress);
        this.id = id;
    }

    public void drawToolTip(final int mx, final int my)
    {
        ...
        AbstractGui.fill(mx + 4, my + 7, mx + 5 + width, my + 17, 0xff000000);
        this.mc.fontRenderer.drawString(s, mx + 5, my + 8, 0xffffff);
    }
    ...
    public void renderButton(final int mx, final int my, final float tick)
    {
        ...
        {
            // Draw a background
            AbstractGui.fill(this.x, this.y, this.x + GuiNBTButton.WIDTH, this.y + GuiNBTButton.HEIGHT, 0x80ffffff);
        ...
        if (this.visible)
        {
            ...
            this.blit(this.x, this.y, (this.id - 1) * 9, 18, GuiNBTButton.WIDTH, GuiNBTButton.HEIGHT);
        }
    }
}
