...
public class Client
{
    ...
    public static void initWearables(final RegisterMiscItems event)
    {
        ...
        Client.renderers.put("ring",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_ring"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
        ...
        Client.renderers.put("belt",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_belt"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
        ...
        Client.renderers.put("hat",
                new WearablesRenderer(ResourceLocation.fromNamespaceAndPath(PokecubeMod.ID, "models/worn/mega_hat"))
                {
                    @OnlyIn(Dist.CLIENT)
                    @Override
                    public void renderWearable(final PoseStack mat, final MultiBufferSource buff,
