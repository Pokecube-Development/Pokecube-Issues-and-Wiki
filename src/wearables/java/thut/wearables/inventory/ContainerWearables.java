...
public class ContainerWearables extends AbstractContainerMenu
{
    ...
    public static final ResourceLocation EMPTY_ARMOR_SLOT_HELMET = ResourceLocation
            .parse("item/empty_armor_slot_helmet");
    public static final ResourceLocation EMPTY_ARMOR_SLOT_CHESTPLATE = ResourceLocation
            .parse("item/empty_armor_slot_chestplate");
    public static final ResourceLocation EMPTY_ARMOR_SLOT_LEGGINGS = ResourceLocation
            .parse("item/empty_armor_slot_leggings");
    ...
    public static class WornSlot extends Slot
    {
                ...
                final int xPosition, final int yPosition)
        {
            ...
            this.wearer = player;
            this.LOCATION = ResourceLocation.parse(EnumWearable.getIcon(this.getSlotIndex()));
        }
