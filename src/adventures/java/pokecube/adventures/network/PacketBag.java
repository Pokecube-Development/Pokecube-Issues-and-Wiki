...
public class PacketBag extends Packet
{
    ...
    public static void sendOpenPacket(final Player sendTo, final UUID owner)
    {
        ...
        final BagInventory inv = BagManager.INSTANCE.get(sendTo.registryAccess(), owner);
        final FriendlyByteBuf clt = inv.makeBuffer();
        final SimpleMenuProvider provider = new SimpleMenuProvider((i, p, e) -> new BagContainer(i, p, inv),
