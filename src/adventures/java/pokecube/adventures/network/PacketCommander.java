...
public class PacketCommander extends Packet
{
    ...
    public void handleServer(final ServerPlayer player)
    {
        ...
        catch (final Exception e)
        {
            ...
            tile.getLevel().playSound(null, tile.getBlockPos(), SoundEvents.NOTE_BLOCK_BASEDRUM.value(),
                    SoundSource.BLOCKS, 1, 1);
        }
        TileUpdate.sendUpdate(tile);
    }

    private final static Type<Packet> TYPE = new Type<Packet>(
            ResourceLocation.parse("pokecube_adventures:commander_packet"));
