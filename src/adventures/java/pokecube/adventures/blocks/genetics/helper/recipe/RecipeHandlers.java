        ...
        public static class RecipeMatcher implements ReviveMatcher
        {
            ...
            public boolean complete(final IPoweredProgress tile)
            {
                ...
                if (entity != null)
                {
                    ...
                    final IMobGenetics genes = ClonerHelper.getGenes(world.registryAccess(), dnaSource);
            ...
            @Override
            public PokedexEntry getEntry(final PoweredCraftingInventory inventory, Level world)
            {
                ...
                if (!this.stacks.isEmpty())
                {
                    ...
                    for (int i = 2; i < inventory.size(); i++)
                    {
                        ...
                        {
                            // TODO See if tag stuff was needed
    ...
    public static class DNARecipeParser implements IRecipeParser
    {
        ...
        public void init()
        {
            ...
            if (PokecubeAdv.config.autoAddFossilDNA)
                for (final Entry<String, DeferredItem<ItemFossil>> fossil : ItemGenerator.fossils.entrySet())
            {
                ...
                info.setEntry(Database.getEntry(name));
