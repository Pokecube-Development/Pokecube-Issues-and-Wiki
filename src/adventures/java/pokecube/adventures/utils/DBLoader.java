...
{
    public static ResourceLocation NAMESLOC = ResourceLocation.fromNamespaceAndPath(PokecubeAdv.MODID, "database/trainer/names.csv");
    ...
    public static void load()
    {
        ...
        if (PokecubeCore.getConfig().debug_data) PokecubeAPI.logInfo("Loading Trainer Databases");
