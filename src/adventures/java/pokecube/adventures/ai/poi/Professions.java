...
{
    public static final Supplier<VillagerProfession> HEALER;
    public static final Supplier<VillagerProfession> PROFESSOR;
    public static final Supplier<VillagerProfession> MERCHANT;
